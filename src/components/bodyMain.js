    ...
    <div className=" mt-32.5 md:mt-313px flex flex-col  lg:flex-row justify-between">
      <div className="">
        <div className="flex flex-col bg-custom-landing-black   items-start h-full relative w-full lp:w-787px  md:w-171 ">
          ...
          <button
            className="mt-13 ml-4.75 mr-239px md:ml-239px md:mt-10 md:mr-313px pt-2 pr-4.5 pb-7px pl-21px text-ft16-22.78
          ...
          <div className=" flex flex-row md:flex-col">
            <button className="ml-4.75 mt-6  md:mt-4 md:ml-239px  md:mr-313px pt-1 pr-4.5 pb-7px pl-21px text-ft16-22.78 rounded-full font-SansProSemiBold border-2 w-max  border-custom-component3-button text-custom-nav-button font-semibold">
              A/B Testing
            </button>

            <button className=" ml-4 mt-6 mr-74px md:mt-4 md:ml-239px  md:mr-313px pt-2 pr-4.5 pb-7px pl-21px text-ft16-22.78 rounded-full font-SansProSemiBold border-2 w-max    border-custom-component3-button  text-custom-nav-button font-semibold">
              Amplified Brand
            </button>
          </div>

          <button className=" ml-4.75 mr-112px mt-6 md:ml-239px  md:mr-313px pt-2 pr-4.5 pb-7px pl-21px text-ft16-22.78 rounded-full font-SansProSemiBold border-2 w-max   mb-25 border-custom-component3-button  text-custom-nav-button font-semibold">
