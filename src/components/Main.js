  ...
  return (
    <div className="flex flex-col cs:flex-row justify-between    ">
      <div className=" ml-4  mt-20.5  cs:mt-40 cs:ml-82.5 cs:mr-45">
        <div className=" text-ft50-53.78 cs:text-ft90-94 text-custom-landing-black  font-HelveticaNeueBold w-max h-108px md:h-188px">
        ...
        <div className="flex flex-row cs:mt-0 mt-23px">
          <input
            type="text"
            id="first_name"
            className=" w-172px  font-SansProRegular text-ft13-16.34   h-12.5 pt-12.91px pb-3 pl-3.5 pr-89px cs:w-50 cs:h-12.5 cs:pt-15px cs:pr-109px cs:pb-3 font-normal  cs:text-ft16-20.11 cs:pl-17px bg-custom-landing-input-bg text-custom-landing-input rounded-sm "
          ...
          <input
            type="text"
            id="first_name"
            className="ml-13px w-172px   font-SansProRegular text-ft13-16.34  h-12.5 pt-13px pb-3 pl-3.5 pr-21px font-normal  cs:ml-4 cs:w-50 cs:h-12.5 cs:pt-15px  cs:text-ft16-20.11 cs:pr-71px cs:pb-3 cs:pl-17px bg-custom-landing-input-bg text-custom-landing-input rounded-sm "
        ...
        <div>
          <input
            ...
            text-ft13-16.34 pt-13px pb-3 pl-3.5 pr-245px font-SansProRegular w-358px  cs:mt-4 cs:w-104 cs:pt-15px cs:pr-67.5 cs:pb-3 cs:pl-17px   cs:text-ft16-20.11 bg-custom-landing-input-bg text-custom-landing-input  rounded-sm  h-12.5  "
          />
        </div>
        <button className="bg-custom-landing-button text-custom-nav-button mt-4 w-358px cs:w-104 h-15  rounded-sm">
          <div>
